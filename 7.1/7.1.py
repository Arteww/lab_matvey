def main():
    ...
    print(f"Мужчина с самой высокой зарплатой: {name_male}")
    print(f"Женщина с самой высокой зарплатой: {name_female} \n")
    ...
    print(f"Средняя зарплата мужчин: {round(sum_salary_male / count_male, 3)}")
    print(f"Средняя зарплата женщин: {round(sum_salary_female / count_female, 3)}")
